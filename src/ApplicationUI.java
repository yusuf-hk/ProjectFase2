...
public class ApplicationUI 
{
        ...
        while (!quit) 
        {
            try 
            {
                ...
                switch (menuSelection) 
                {
                    ...
                    case 2:
                        this.addNewProduct(inputLine);
                        break;

                    case 3:
                        this.findProductByName(inputLine);
                        break;
    ...
    {
        System.out.println(book = new Book(input, input, input, input, input, input, input, input));
     ...
     */
    void findProductByName(String input)
    {
        bookRegistry.listByTitle(input);
